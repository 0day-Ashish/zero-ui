...
import React, { forwardRef, useState, createElement, useRef, useId, useEffect, useCallback } from 'react';
...
function Dots({ className }) {
  return /* @__PURE__ */ jsxs("div", { className: `flex items-center gap-1 ${className}`, children: [
    /* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 bg-current rounded-full animate-bounce [animation-delay:-0.3s]" }),
    /* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 bg-current rounded-full animate-bounce [animation-delay:-0.15s]" }),
    /* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 bg-current rounded-full animate-bounce" })
  ] });
}
function Pulse({ className }) {
  return /* @__PURE__ */ jsxs("div", { className: `flex items-center gap-0.5 ${className}`, children: [
    /* @__PURE__ */ jsx("span", { className: "w-1 h-4 bg-current rounded-full animate-pulse [animation-delay:-0.3s]" }),
    /* @__PURE__ */ jsx("span", { className: "w-1 h-4 bg-current rounded-full animate-pulse [animation-delay:-0.15s]" }),
    /* @__PURE__ */ jsx("span", { className: "w-1 h-4 bg-current rounded-full animate-pulse" })
  ] });
}
...
function ButtonLoading(_a) {
  ...
  const LoadingIndicator = () => {
    switch (loadingVariant) {
      case "dots":
        return /* @__PURE__ */ jsx(Dots, { className: iconSizes[size] });
      case "pulse":
        return /* @__PURE__ */ jsx(Pulse, { className: iconSizes[size] });
      default:
        return /* @__PURE__ */ jsx(Spinner, { className: iconSizes[size] });
    }
  };
  ...
  return /* @__PURE__ */ jsxs(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        ...
        isCompleted && !isLoading && /* @__PURE__ */ jsx(CheckIcon, { className: iconSizes[size] }),
        /* @__PURE__ */ jsx("span", { className: isLoading ? "opacity-70" : "", children: isCompleted && !isLoading ? completedText : children })
      ]
    })
  );
}
...
function GitHubIcon({ className }) {
  return /* @__PURE__ */ jsx("svg", { className, viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" }) });
}
function TwitterIcon({ className }) {
  return /* @__PURE__ */ jsx("svg", { className, viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" }) });
}
function FacebookIcon({ className }) {
  return /* @__PURE__ */ jsx("svg", { className, viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" }) });
}
function AppleIcon({ className }) {
  return /* @__PURE__ */ jsx("svg", { className, viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M12.152 6.896c-.948 0-2.415-1.078-3.96-1.04-2.04.027-3.91 1.183-4.961 3.014-2.117 3.675-.546 9.103 1.519 12.09 1.013 1.454 2.208 3.09 3.792 3.039 1.52-.065 2.09-.987 3.935-.987 1.831 0 2.35.987 3.96.948 1.637-.026 2.676-1.48 3.676-2.948 1.156-1.688 1.636-3.325 1.662-3.415-.039-.013-3.182-1.221-3.22-4.857-.026-3.04 2.48-4.494 2.597-4.559-1.429-2.09-3.623-2.324-4.39-2.376-2-.156-3.675 1.09-4.61 1.09zM15.53 3.83c.843-1.012 1.4-2.427 1.245-3.83-1.207.052-2.662.805-3.532 1.818-.78.896-1.454 2.338-1.273 3.714 1.338.104 2.715-.688 3.559-1.701" }) });
}
function DiscordIcon({ className }) {
  return /* @__PURE__ */ jsx("svg", { className, viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M20.317 4.3698a19.7913 19.7913 0 00-4.8851-1.5152.0741.0741 0 00-.0785.0371c-.211.3753-.4447.8648-.6083 1.2495-1.8447-.2762-3.68-.2762-5.4868 0-.1636-.3933-.4058-.8742-.6177-1.2495a.077.077 0 00-.0785-.037 19.7363 19.7363 0 00-4.8852 1.515.0699.0699 0 00-.0321.0277C.5334 9.0458-.319 13.5799.0992 18.0578a.0824.0824 0 00.0312.0561c2.0528 1.5076 4.0413 2.4228 5.9929 3.0294a.0777.0777 0 00.0842-.0276c.4616-.6304.8731-1.2952 1.226-1.9942a.076.076 0 00-.0416-.1057c-.6528-.2476-1.2743-.5495-1.8722-.8923a.077.077 0 01-.0076-.1277c.1258-.0943.2517-.1923.3718-.2914a.0743.0743 0 01.0776-.0105c3.9278 1.7933 8.18 1.7933 12.0614 0a.0739.0739 0 01.0785.0095c.1202.099.246.1981.3728.2924a.077.077 0 01-.0066.1276 12.2986 12.2986 0 01-1.873.8914.0766.0766 0 00-.0407.1067c.3604.698.7719 1.3628 1.225 1.9932a.076.076 0 00.0842.0286c1.961-.6067 3.9495-1.5219 6.0023-3.0294a.077.077 0 00.0313-.0552c.5004-5.177-.8382-9.6739-3.5485-13.6604a.061.061 0 00-.0312-.0286zM8.02 15.3312c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9555-2.4189 2.157-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419 0 1.3332-.9555 2.4189-2.1569 2.4189zm7.9748 0c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9554-2.4189 2.1569-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419 0 1.3332-.946 2.4189-2.1568 2.4189z" }) });
}
function LinkedInIcon({ className }) {
  return /* @__PURE__ */ jsx("svg", { className, viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" }) });
}
function SpotifyIcon({ className }) {
  return /* @__PURE__ */ jsx("svg", { className, viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.779-.179-.899-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.479.659.301 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-1.98-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141C9.6 9.9 15 10.561 18.72 12.84c.361.181.54.78.241 1.2zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.301c-.6.179-1.2-.181-1.38-.721-.18-.601.18-1.2.72-1.381 4.26-1.26 11.28-1.02 15.721 1.621.539.3.719 1.02.419 1.56-.299.421-1.02.599-1.559.3z" }) });
}
var providerIcons = {
  google: GoogleIcon,
  github: GitHubIcon,
...
function ButtonSocial(_a) {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        /* @__PURE__ */ jsx(Icon2, { className: iconSizes[size] }),
        variant !== "icon" && /* @__PURE__ */ jsx("span", { children: children || defaultText })
      ]
    })
  );
}
...
function NoiseFilter({ id, effect }) {
  ...
  return /* @__PURE__ */ jsx("svg", { className: "absolute w-0 h-0", "aria-hidden": "true", children: /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("filter", { id, children: [
    /* @__PURE__ */ jsx(
      "feTurbulence",
      {
        type: "fractalNoise",
    ...
    /* @__PURE__ */ jsx("feColorMatrix", { type: "saturate", values: "0", in: "noise", result: "mono" }),
    /* @__PURE__ */ jsx("feBlend", { in: "SourceGraphic", in2: "mono", mode: "overlay" })
  ] }) }) });
}
function NoiseOverlay({ effect, opacity, filterId }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(NoiseFilter, { id: filterId, effect }),
    /* @__PURE__ */ jsx(
      "div",
      {
...
function RippleEffect({ ripples, onAnimationEnd }) {
  return /* @__PURE__ */ jsx(Fragment, { children: ripples.map((ripple) => /* @__PURE__ */ jsx(
    "span",
    {
...
function BorderWrapper({
  ...
  if (effect === "rotating") {
    return /* @__PURE__ */ jsxs("div", { className: "relative inline-flex rounded-2xl overflow-hidden p-[2px]", children: [
      /* @__PURE__ */ jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsx("div", { className: "relative rounded-2xl", children })
    ] });
  }
  if (effect === "pulsing") {
  ...
  const buttonElement = /* @__PURE__ */ jsxs(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        ...
        noiseEffect !== "none" && /* @__PURE__ */ jsx(NoiseOverlay, { effect: noiseEffect, opacity: noiseOpacity, filterId }),
        getCursorOverlay(),
        cursorEffect === "ripple" && /* @__PURE__ */ jsx(RippleEffect, { ripples, onAnimationEnd: handleRippleEnd }),
        borderEffect === "glow" && /* @__PURE__ */ jsx(
          "span",
          {
        ...
        /* @__PURE__ */ jsx("span", { className: `relative z-10 drop-shadow-sm ${borderEffect !== "none" ? "text-zinc-900 dark:text-white" : "text-white"}`, children })
      ]
    })
  );
  return /* @__PURE__ */ jsx(BorderWrapper, { effect: borderEffect, colors, children: buttonElement });
}
var sizes2 = {
...
var InputBase = forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "w-full space-y-2", children: [
      label && /* @__PURE__ */ jsx("label", { className: "text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-zinc-900 dark:text-zinc-100", children: label }),
      /* @__PURE__ */ jsx(
        "input",
        __spreadValues({
          ref,
      ...
      helperText && /* @__PURE__ */ jsx("p", { className: `text-xs ${error ? "text-red-500" : "text-zinc-500"}`, children: helperText })
    ] });
  }
);
InputBase.displayName = "InputBase";
var input_base_default = InputBase;
var InputFloating = forwardRef(
  (_a, ref) => {
    var _b = _a, { className, label, error } = _b, props = __objRest(_b, ["className", "label", "error"]);
    return /* @__PURE__ */ jsxs("div", { className: "relative z-0 w-full group", children: [
      /* @__PURE__ */ jsx(
        "input",
        __spreadValues({
          ref,
...
var InputIcon = forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "relative w-full", children: [
      Icon2 && iconPosition === "left" && /* @__PURE__ */ jsx("div", { className: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none", children: /* @__PURE__ */ jsx(Icon2, { className: `h-5 w-5 text-zinc-500 ${iconClassName}` }) }),
      /* @__PURE__ */ jsx(
        "input",
        __spreadValues({
          ref,
      ...
      Icon2 && iconPosition === "right" && /* @__PURE__ */ jsx("div", { className: "absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none", children: /* @__PURE__ */ jsx(Icon2, { className: `h-5 w-5 text-zinc-500 ${iconClassName}` }) })
    ] });
  }
);
InputIcon.displayName = "InputIcon";
var input_icon_default = InputIcon;
var InputGradient = forwardRef(
  (_a, ref) => {
...
function InputOTP({
  ...
  return /* @__PURE__ */ jsx("div", { className: cn("flex gap-2 items-center justify-center", className), children: code.map((value, index) => /* @__PURE__ */ jsx(
    "input",
    {
      ref: (el) => {
...
function InputFile(_a) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("w-full space-y-2", className), children: [
    label && /* @__PURE__ */ jsx("label", { className: "text-sm font-medium leading-none text-zinc-900 dark:text-zinc-100", children: label }),
    /* @__PURE__ */ jsxs(
      "div",
      {
        className: cn(
        ...
        children: [
          ...
          selectedFile ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center p-4 animate-in fade-in zoom-in-95 duration-200", children: [
            /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-lg bg-violet-100 dark:bg-violet-900/30 flex items-center justify-center mb-2 text-violet-600 dark:text-violet-400", children: /* @__PURE__ */ jsx(File, { className: "w-6 h-6" }) }),
            /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-zinc-900 dark:text-zinc-100 text-center truncate max-w-[200px]", children: selectedFile.name }),
          ...
          ] }) : /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center text-center p-4", children: [
            /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-full bg-zinc-200 dark:bg-zinc-800 flex items-center justify-center mb-3 text-zinc-500", children: /* @__PURE__ */ jsx(Upload, { className: "w-5 h-5" }) }),
            /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-zinc-700 dark:text-zinc-300", children: "Click to upload or drag and drop" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-zinc-500 mt-1", children: accept ? `Accepted formats: ${accept}` : "All files accepted" })
          ] })
        ]
      }
    ),
    helperText && !selectedFile && /* @__PURE__ */ jsx("p", { className: "text-xs text-zinc-500", children: helperText })
  ] });
}
function InputTags({
  label,
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("w-full space-y-2", className), children: [
    ...
    helperText && /* @__PURE__ */ jsx("p", { className: "text-xs text-zinc-500", children: helperText })
  ] });
}
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("span", { className: "relative z-10", children: content }),
              /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-white/5 w-full h-full animate-blink pointer-events-none" })
            ]
          }
        )
      ]
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-cyan-500/10 backdrop-blur-md rounded-lg border border-cyan-400/30 shadow-[0_0_15px_rgba(34,211,238,0.3)]" }),
              /* @__PURE__ */ jsx(
                "div",
                {
              ...
              /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[linear-gradient(rgba(18,255,255,0.1)_1px,transparent_1px)] bg-[size:100%_4px] rounded-lg pointer-events-none" }),
              /* @__PURE__ */ jsx("span", { className: "relative z-10 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]", children: content })
            ]
          }
        )
      ]
        ...
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "relative group", children: [
              /* @__PURE__ */ jsx("div", { className: "relative z-10 bg-black/90 text-white font-mono text-xs px-3 py-1.5 border-l-2 border-red-500 clip-path-polygon-[0_0,_100%_0,_100%_100%,_10%_100%,_0_80%]", children: /* @__PURE__ */ jsx("span", { className: "tracking-widest uppercase", children: content }) }),
              /* @__PURE__ */ jsx(
                "div",
                {
                  className: cn(
...
function Tabs({ defaultValue, className, children }) {
  ...
  return /* @__PURE__ */ jsx(TabsContext.Provider, { value: { activeTab, setActiveTab }, children: /* @__PURE__ */ jsx("div", { className: cn("w-full", className), children }) });
}
function TabsList({ children, className }) {
  return /* @__PURE__ */ jsx("div", { className: cn("inline-flex items-center justify-center rounded-lg bg-zinc-100 p-1 text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400", className), children });
}
function TabsTrigger({ value, children, className, icon }) {
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        icon && /* @__PURE__ */ jsx("span", { className: "w-4 h-4", children: icon }),
        children
      ]
    }
  );
...
var TabsGlassContext = React.createContext(null);
function TabsGlass({ defaultValue, className, children }) {
  const [activeTab, setActiveTab] = useState(defaultValue);
  return /* @__PURE__ */ jsx(TabsGlassContext.Provider, { value: { activeTab, setActiveTab }, children: /* @__PURE__ */ jsx("div", { className: cn("w-full group/tabs", className), children }) });
}
function TabsGlassList({ children, className }) {
  return /* @__PURE__ */ jsx("div", { className: cn("relative flex items-center gap-2 p-1.5 rounded-full bg-white/20 dark:bg-black/20 backdrop-blur-xl border border-white/20 dark:border-white/10 shadow-lg w-fit", className), children });
}
function TabsGlassTrigger({ value, children, className, icon }) {
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        isActive && /* @__PURE__ */ jsx("span", { className: "absolute inset-0 bg-white/80 dark:bg-zinc-800/80 shadow-sm rounded-full -z-10 animate-in fade-in zoom-in-95 duration-200" }),
        icon && /* @__PURE__ */ jsx("span", { className: "w-4 h-4", children: icon }),
        children
      ]
    }
...
function TabsGlassContent({ value, children, className }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: cn("mt-4 p-6 rounded-2xl bg-white/40 dark:bg-black/40 backdrop-blur-md border border-white/20 dark:border-white/10 shadow-xl animate-in slide-in-from-bottom-2 fade-in duration-300", className), children });
}
var TabsNeonContext = React.createContext(null);
function TabsNeon({ defaultValue, className, children }) {
  const [activeTab, setActiveTab] = useState(defaultValue);
  return /* @__PURE__ */ jsx(TabsNeonContext.Provider, { value: { activeTab, setActiveTab }, children: /* @__PURE__ */ jsx("div", { className: cn("w-full", className), children }) });
}
function TabsNeonList({ children, className }) {
  return /* @__PURE__ */ jsx("div", { className: cn("flex items-center gap-8 border-b border-zinc-800/50 pb-px mb-6 px-4", className), children });
}
...
function TabsNeonContent({ value, children, className }) {
  ...
  if (context.activeTab !== value) return null;
  return /* @__PURE__ */ jsx("div", { className: cn("animate-in fade-in duration-500", className), children });
}
var TabsCyberContext = React.createContext(null);
function TabsCyber({ defaultValue, className, children }) {
  const [activeTab, setActiveTab] = useState(defaultValue);
  return /* @__PURE__ */ jsx(TabsCyberContext.Provider, { value: { activeTab, setActiveTab }, children: /* @__PURE__ */ jsx("div", { className: cn("w-full bg-zinc-950/50 p-1", className), children }) });
}
function TabsCyberList({ children, className }) {
  return /* @__PURE__ */ jsx("div", { className: cn("flex flex-wrap gap-2 mb-8", className), children });
}
function TabsCyberTrigger({ value, children, className }) {
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        !isActive && /* @__PURE__ */ jsx("span", { className: "absolute top-0 right-0 w-2 h-2 border-t border-r border-zinc-700" }),
        !isActive && /* @__PURE__ */ jsx("span", { className: "absolute bottom-0 left-0 w-2 h-2 border-b border-l border-zinc-700" }),
        children
      ]
    }
  );
...
function TabsCyberContent({ value, children, className }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn(
    ...
    /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-10 w-20 h-px bg-zinc-800" }),
    /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-10 w-20 h-px bg-zinc-800" }),
    children
  ] });
}
...
var PaginationGlassContent = React.forwardRef((_a, ref) => {
  var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
  return /* @__PURE__ */ jsx(
    "ul",
    __spreadValues({
...
var PaginationGlassItem = React.forwardRef((_a, ref) => {
  var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
  return /* @__PURE__ */ jsx("li", __spreadValues({ ref, className: cn("", className) }, props));
});
...
var PaginationNeonContent = React.forwardRef((_a, ref) => {
  var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
  return /* @__PURE__ */ jsx(
    "ul",
    __spreadValues({
...
var PaginationNeonItem = React.forwardRef((_a, ref) => {
  var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
  return /* @__PURE__ */ jsx("li", __spreadValues({ ref, className: cn("", className) }, props));
});
var PaginationNeonLink = (_a) => {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        isActive && /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-cyan-400/10 animate-pulse" }),
...
var PaginationCyberContent = React.forwardRef((_a, ref) => {
  var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
  return /* @__PURE__ */ jsx(
    "ul",
    __spreadValues({
...
var PaginationCyberItem = React.forwardRef((_a, ref) => {
  var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
  return /* @__PURE__ */ jsx("li", __spreadValues({ ref, className: cn("", className) }, props));
});
...
function AccordionBase({ title, children, className, defaultOpen = false }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("border-b border-zinc-200 dark:border-zinc-800", className), children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "text-sm text-zinc-500 dark:text-zinc-400", children })
      }
    )
  ] });
}
function AccordionGlass({ title, children, className, defaultOpen = false }) {
  const [isOpen, setIsOpen] = useState(defaultOpen);
  return /* @__PURE__ */ jsxs("div", { className: cn("mb-4 rounded-xl overflow-hidden border border-white/20 dark:border-white/10 bg-white/10 dark:bg-black/10 backdrop-blur-md shadow-sm transition-all duration-300", isOpen && "bg-white/20 dark:bg-black/20 shadow-md", className), children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsx("span", { className: "font-semibold text-zinc-800 dark:text-white", children: title }),
          /* @__PURE__ */ jsx("div", { className: cn("p-1 rounded-full bg-white/20 dark:bg-white/10 transition-transform duration-300", isOpen && "rotate-180 bg-white/40 dark:bg-white/20"), children: isOpen ? /* @__PURE__ */ jsx(Minus, { className: "w-4 h-4" }) : /* @__PURE__ */ jsx(Plus, { className: "w-4 h-4" }) })
        ]
      }
    ),
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "p-4 pt-0 text-sm text-zinc-600 dark:text-zinc-300 leading-relaxed border-t border-white/10", children })
      }
    )
  ] });
}
function AccordionNeon({ title, children, className, defaultOpen = false }) {
  const [isOpen, setIsOpen] = useState(defaultOpen);
  return /* @__PURE__ */ jsxs("div", { className: cn("mb-4 group", className), children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsxs("span", { className: "font-bold tracking-wide uppercase flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: cn("w-2 h-2 rounded-full transition-colors duration-300", isOpen ? "bg-cyan-400 shadow-[0_0_8px_rgba(34,211,238,1)]" : "bg-zinc-700") }),
            title
          ] }),
          /* @__PURE__ */ jsx(
            ChevronRight,
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "p-4 text-sm text-cyan-100/80 font-light leading-relaxed", children })
      }
    )
  ] });
}
function AccordionCyber({ title, id, children, className, defaultOpen = false }) {
  const [isOpen, setIsOpen] = useState(defaultOpen);
  return /* @__PURE__ */ jsxs("div", { className: cn("mb-2 relative", className), children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsxs("span", { className: "font-mono text-sm uppercase tracking-wider", children: [
            /* @__PURE__ */ jsxs("span", { className: "opacity-50 mr-3", children: [
              "[",
              id,
              "]"
            ] }),
          ...
          /* @__PURE__ */ jsx("div", { className: cn("mr-4 text-xs font-mono transition-opacity", isOpen ? "opacity-100" : "opacity-50"), children: isOpen ? "[-]" : "[+]" }),
          isOpen && /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-yellow-500/5 pointer-events-none" })
        ]
      }
    ),
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "text-xs font-mono text-zinc-400 leading-relaxed border-l-2 border-yellow-500/50 pl-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-yellow-500/40 select-none mr-2", children: ">" }),
          children
        ] })
      }
    )
      ...
      children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("span", { className: cn("text-lg font-bold tracking-tight transition-colors", isOpen ? "text-zinc-900 dark:text-zinc-100" : "text-zinc-600 dark:text-zinc-400"), children: title }),
              /* @__PURE__ */ jsx(
                "div",
                {
                  className: cn(
                  ...
                  children: /* @__PURE__ */ jsx(Plus, { className: cn("w-5 h-5 transition-colors duration-300", isOpen ? "text-white dark:text-zinc-900" : "text-zinc-900 dark:text-zinc-100") })
                }
              )
            ]
          }
        ...
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx("div", { className: "text-zinc-600 dark:text-zinc-400 font-medium leading-relaxed", children })
          }
        )
      ]
    }
...
function AccordionBorder({ title, children, className, defaultOpen = false }) {
  const [isOpen, setIsOpen] = useState(defaultOpen);
  return /* @__PURE__ */ jsxs("div", { className: cn("relative mb-px group", className), children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: cn("absolute inset-0 bg-zinc-100 dark:bg-zinc-800 transition-transform duration-500 ease-out origin-left", isOpen ? "scale-x-100" : "scale-x-0 group-hover:scale-x-5") }),
          /* @__PURE__ */ jsx("span", { className: cn("relative z-10 text-xl font-light tracking-wide transition-colors duration-300 pl-4", isOpen ? "text-zinc-900 dark:text-zinc-100 pl-6" : "text-zinc-500 group-hover:text-zinc-900 dark:group-hover:text-zinc-300"), children: title }),
          /* @__PURE__ */ jsx("div", { className: cn("relative z-10 pr-4 transition-transform duration-500", isOpen ? "rotate-180" : "group-hover:translate-y-1"), children: /* @__PURE__ */ jsx(ArrowDown, { className: "w-5 h-5 font-thin", strokeWidth: 1.5 }) }),
          /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 w-full h-px bg-zinc-200 dark:bg-zinc-800" }),
          /* @__PURE__ */ jsx("div", { className: cn("absolute bottom-0 left-0 w-full h-px bg-zinc-900 dark:bg-zinc-100 transition-transform duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] origin-left", isOpen ? "scale-x-100" : "scale-x-0") })
        ]
      }
    ),
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "py-6 px-6 text-zinc-600 dark:text-zinc-400 font-light leading-relaxed text-lg border-l border-zinc-200 dark:border-zinc-800 ml-4", children })
      }
    )
  ] });
}
function AccordionImage({ items, className }) {
  var _a;
  const [activeItem, setActiveItem] = useState(((_a = items[0]) == null ? void 0 : _a.id) || null);
  return /* @__PURE__ */ jsx("div", { className: cn("flex flex-col md:flex-row gap-2 w-full h-[500px]", className), children: items.map((item) => {
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { className: cn("absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent transition-opacity duration-500", isActive ? "opacity-80" : "opacity-40 group-hover:opacity-60") }),
          /* @__PURE__ */ jsxs("div", { className: "absolute inset-x-0 bottom-0 p-6 flex flex-col justify-end", children: [
            /* @__PURE__ */ jsx("div", { className: cn("absolute bottom-6 left-6 origin-bottom-left -rotate-90 md:block hidden transition-opacity duration-300", isActive ? "opacity-0 invisible" : "opacity-100 visible"), children: /* @__PURE__ */ jsx("p", { className: "text-white font-bold text-2xl whitespace-nowrap tracking-wider", children: item.title }) }),
            /* @__PURE__ */ jsxs("div", { className: cn("transition-all duration-500 delay-100", isActive ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0 hidden md:block"), children: [
              /* @__PURE__ */ jsx("h3", { className: cn("text-white font-bold text-2xl mb-2", !isActive && "md:hidden"), children: item.title }),
              /* @__PURE__ */ jsx("p", { className: "text-white/80 text-sm md:text-base line-clamp-2 md:line-clamp-none", children: item.description })
            ] })
          ] })
        ]
      },
